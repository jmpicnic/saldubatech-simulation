 ...
 * Copyright (c) 2019. Salduba Technologies LLC, all right reserved
 */
package com.saldubatech.v1.equipment.units.shuttle.lift

import akka.actor.{ActorRef, ActorSystem, Props}
import akka.testkit.TestProbe
import com.saldubatech.v1.base.channels.Channel.{AcknowledgeLoad, TransferLoad}
import com.saldubatech.v1.base.processor.Processor.{CompleteTask, ConfigureOwner, DeliverResult, ReceiveLoad, StageLoad, StartTask}
...
import com.saldubatech.v1.equipment.units.shuttle.LiftExecutor
