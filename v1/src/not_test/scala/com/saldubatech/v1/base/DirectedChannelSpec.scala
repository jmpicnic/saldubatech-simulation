...
import com.saldubatech.v1.base.channels.Channel.{AcknowledgeLoad, ConfigureEnds, ConfigureStarts, TransferLoad}
import com.saldubatech.v1.base.channels.v1.AbstractChannel
...
import com.saldubatech.v1.equipment.elements.{Discharge, Induct, StepProcessor}
...
/*	"A Material Channel" when {
		"created" must {
			...
			//"2. Accept an activation once configuration is complete" in {
				//Await.result(gw.isConfigurationComplete, 1 second) shouldBe Simulation.SimulationState.READY
				gw.activate()
			//}
