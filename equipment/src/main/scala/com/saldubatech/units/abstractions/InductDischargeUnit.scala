...
object InductDischargeUnit {
	...
	def inductSink[HS >: ChannelConnections.ChannelSourceSink, H <: InductDischargeUnit[HS]]
	...
	def dischargeSource[HS >: ChannelConnections.ChannelSourceSink, H <: InductDischargeUnit[HS]]
...
trait InductDischargeUnit[HOST_SIGNAL >: ChannelConnections.ChannelSourceSink]  extends EquipmentUnit[HOST_SIGNAL] {
