...
class PalletizerOnePalletByNumberSpec(_system: ActorSystem) extends BaseActorSpec(_system) {
	import PalletizerOnePalletByNumberSpec._
	import SpecActorHarness._


	def this() = this(ActorSystem("PalletizerOnePalletByNumberSpec"))
...
object PalletizerOnePalletByNumberSpec {
	import SpecActorHarness._
