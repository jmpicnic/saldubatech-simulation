...
class LoadAwareShuttleLiftSorterFlowOutboundSpec
	...
	"A GTP BackEnd" should {
		...
		val sorterAisleA = Channel.Ops(new UnitSorterToLoadAwareLift(() => Some(20L), () => Some(3), cards, 1, s"sorter_aisle_A"))
		val sorterAisleB = Channel.Ops(new UnitSorterToLoadAwareLift(() => Some(20L), () => Some(3), cards, 1, s"sorter_aisle_B"))
		val aisleASorter = Channel.Ops(new LoadAwareLiftToUnitSorter(() => Some(20L), () => Some(3), cards, 1, s"aisle_sorter_A"))
		val aisleBSorter = Channel.Ops(new LoadAwareLiftToUnitSorter(() => Some(20L), () => Some(3), cards, 1, s"aisle_sorter_B"))
